                        ...
                        <div class="container px-5 py-8 mx-auto">
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  <label for="is_selling" class="leading-7 text-sm text-gray-600">状態</label>
                                  <input value="1" v-model="form.is_selling" type="radio" id="is_selling" name="is_selling" class="">
                                  <label for="is_selling" class="leading-7 text-sm text-gray-600">販売中</label>
                                  <input value="0" v-model="form.is_selling" type="radio" id="is_selling" name="is_selling" class="">
