                            ...
                            <div class="flex flex-wrap -m-2">
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <div id="name" class="w-fullbg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    {{ item.name }}
                                  </div>
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <div v-html="nl2br(item.memo)" id="memo" class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">
                                  </div>
                              ...
                              <div class="p-2 w-full">
                                <Link class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" as="button" :href="route('items.edit', {item:item.id})">
                                編集
                                </Link>
                              </div>
